-- Migration: Ajouter les colonnes d'onboarding à la table profiles existante
...
-- Ajouter la contrainte check pour arrival_transport (si elle n'existe pas)
-- Note: Si vous obtenez une erreur sur la contrainte, ignorez-la
DO $$
BEGIN
  ALTER TABLE public.profiles 
...
-- Créer la table family_members si elle n'existe pas
